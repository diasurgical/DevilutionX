...
const char *QUEST_OGDEN'S_SIGN_NAME = N_("Ogden's Sign");
...
const char *QUEST_FARMER'S_ORCHARD_NAME = N_("Farmer's Orchard");
...
const char *QUEST_THE_JERSEY'S_JERSEY_NAME = N_("The Jersey's Jersey");
