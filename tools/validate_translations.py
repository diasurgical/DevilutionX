...
def validateEntry(original, translation):
	...
	if src_arguments is None:
		print ("\033[31mMalformed format string in source message: " + original + "\033[0m")
		return False
	...
	if translated_arguments is None:
		print ("\033[36m" + original + "\033[0m has an unmatched/unescaped brace in \033[31m" + translation + "\033[0m")
		return False
	...
	for argument in src_arguments:
		if re.search(r"^{\d+}$", argument) == None:
			isOrdered = False
			break
